...
row.names(plasma_lncRNA_data) <- gsub(pattern = "_9796", replacement = "", x = row.names(plasma_lncRNA_data))
...
row.names(sf_lncRNA_data) <- gsub(pattern = "_9796", replacement = "", x = row.names(sf_lncRNA_data))
